#define BLYNK_TEMPLATE_ID "TMPL63GX1HWTj"
#define BLYNK_TEMPLATE_NAME "DHT Sensor Work By Hadia Usman"
#define BLYNK_AUTH_TOKEN "CQolYY6_v6UTz18_-ri4Sq4_U4-cmLem" // <-- from Blynk device_hLmtVUUWlhtBanXKpviBJt0D_zIBJsA

...
// ---------- MQTT ----------
const char* mqtt_server ="10.13.57.83"; // Change to your MQTT broker IP
const int mqtt_port = 1883;

const char* TOPIC_TEMP = "home/AIlab1/temp"; // Topic for temperature
...
void connectMQTT() {
  while (!mqtt.connected()) {
    ...
    if (mqtt.connect("ESP32Subscriber")) {

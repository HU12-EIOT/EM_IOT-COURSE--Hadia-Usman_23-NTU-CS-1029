...
// ---------- MQTT ----------
const char* mqtt_server = "192.168.10.4";  // Mosquitto / Cloud broker
const int   mqtt_port   = 1883;

// Topics
const char* TOPIC_TEMP = "home/Iot-Lab14/temp";
const char* TOPIC_HUM  = "home/Iot-Lab14/hum";
